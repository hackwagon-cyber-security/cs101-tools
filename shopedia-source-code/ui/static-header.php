...
<div class="ui inverted menu" style="background: rgb(45,45,45); height: 140px; border-radius: 0px; margin-bottom: 0px;">
  <script>
    $(function(){
  ...
  <div class="ui container">
    <div class="item">
      <a href="/"><img src="/assets/images/shopedia-white-logo.png" style="width: 120px;"></a>
    </div>

    <div class="ui item category search search-bar" style="width: 50%; flex-direction: column; flex-flow: wrap;">
      <div class="ui icon input">
        <input id="search-bar-input-2" class="prompt" type="text" placeholder="Search in Shopedia">
